...
______________________________
*/
if(class_exists('_beans_admin_column_tab') === FALSE) :
class _beans_admin_column_tab
{
/**
 * @since 1.0.1
	...
	*/
	public function update()
	{
		/**
			...
			@reference
				[Plugin]/include/constant.php
				[Plugin]/admin/atb/app/column.php
		*/
		// bx_option_{tab_name}
		$option = get_option(BEANS_EXTENSION_PREFIX['option'] . self::$_index);
		if(empty($option)){return;}

		new \Beans_Extension\_beans_admin_column_app();
...
// new _beans_admin_column_tab();
_beans_admin_column_tab::__get_instance();
