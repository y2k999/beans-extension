!(function($){
	...
	var bsFields = function(element,options){
	...
	bsFields.prototype = {
		...
		listen:function(){
			...
			// Reset confirmation.
			this.container.on('click','[name="bs_reset_options"]',function(e){
				return confirm('Are you sure you would like to reset?');
			});
		}
	};

	$.fn['bsFields'] = function(options){

		return this.each(function(){
			if(!$.data(this,'plugin_bsFields')){
				$.data(this,'plugin_bsFields',new beansFields(this,options));
			}
		});
	};
